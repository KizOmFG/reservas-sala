    ...
    template: `
        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <div style="border-radius: 56px; padding: 0.3rem; background: , rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Bienvenido a Muebles CrisJo</div>
                        ...
                        <div>
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary">Se olvido su Contraseña?</span>
                            </div>
